...
<body id="page-top">
    ...
    <section id="privacy">
        ...
        <div class="container px-5 py-5" data-aos="fade-in" data-aos-duration="1500">
            ...
            <p>Kami menghargai privasi Anda dan berkomitmen untuk melindungi data pribadi Anda saat menggunakan aplikasi
                Kuis Saldo.
            ...
            <ul>
                ...
                <li><strong>Data Penggunaan:</strong> Kami mengumpulkan data mengenai bagaimana Anda berinteraksi dengan
                    aplikasi,
                    termasuk aktivitas bermain kuis, skor, dan preferensi Anda.</li>
                <li><strong>Informasi Teknis:</strong> Ini termasuk informasi tentang perangkat yang Anda gunakan, nama
                    perangkat,
            ...
            <ul>
                <li><strong>Menyediakan Layanan:</strong> Mengelola akun Anda, mengoptimalkan pengalaman bermain kuis,
                    dan
                ...
                <li><strong>Komunikasi:</strong> Mengirimkan pemberitahuan, pembaruan, atau promosi terkait dengan
                    aplikasi.</li>
                <li><strong>Keamanan:</strong> Memantau dan mencegah aktivitas yang mencurigakan atau ilegal yang dapat
                    merugikan
            ...
            <p>Kami mengambil langkah-langkah yang wajar untuk melindungi informasi pribadi Anda dari akses, penggunaan,
                atau
                pengungkapan yang tidak sah. Namun, perlu diingat bahwa tidak ada metode transmisi data melalui internet
                atau metode
                penyimpanan elektronik yang 100% aman.</p>

            <h4>4. Penyimpanan dan Penghapusan Data</h4>
            <p>Kami menyimpan informasi pribadi Anda hanya selama diperlukan untuk tujuan yang diuraikan dalam Kebijakan
                Privasi
            ...
            <h4>7. Kontak Kami</h4>
            <p>Jika Anda memiliki pertanyaan atau kekhawatiran terkait Kebijakan Privasi ini, silakan hubungi kami.</p>
    ...
    <section id="terms">
        <div class="container px-5" data-aos="fade-in" data-aos-duration="1500">
            ...
            <p>Selamat datang di Kuis Saldo! Dengan menggunakan aplikasi kami, Anda setuju dengan syarat dan ketentuan berikut:</p>

            <h4>1. Penerimaan Syarat dan Ketentuan</h4>
            <p>Dengan mengakses atau menggunakan Kuis Saldo, Anda menyetujui untuk terikat oleh syarat dan ketentuan ini. Jika Anda tidak setuju dengan syarat dan ketentuan ini, Anda sebaiknya tidak menggunakan aplikasi ini.</p>
    ...
    <section id="faq">
        <div class="container px-5" data-aos="fade-in" data-aos-duration="1500">
            ...
            <p>Kuis Saldo adalah aplikasi yang memungkinkan Anda untuk mengikuti kuis dan mendapatkan saldo sebagai hadiah. Anda dapat menjawab pertanyaan kuis, mengumpulkan poin, dan menukarkannya dengan saldo.</p>

            <h4>2. Bagaimana cara saya mendapatkan saldo?</h4>
            <p>Anda dapat mengumpulkan poin dengan mengikuti kuis. Setelah mencapai jumlah poin tertentu, Anda dapat menukarkannya dengan saldo ShopeePay atau Dana.</p>

            <h4>3. Apakah saya perlu membayar untuk menggunakan Kuis Saldo?</h4>
            <p>Tidak, Kuis Saldo adalah aplikasi gratis. Anda dapat mengikuti kuis dan mendapatkan saldo tanpa biaya apapun.</p>

            <h4>4. Bagaimana cara saya menukarkan poin dengan saldo?</h4>
            <p>Setelah Anda mengumpulkan poin yang cukup, Anda dapat menukarkannya melalui menu penukaran di dalam aplikasi. Pilih saldo yang Anda inginkan, dan poin Anda akan dikonversi secara otomatis.</p>
            ...
            <p>Saat ini, Kuis Saldo tersedia untuk perangkat Android. Kami sedang dalam pengembangan untuk mendukung platform lain di masa depan.</p>
