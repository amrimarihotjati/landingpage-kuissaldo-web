            ...
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="mb-5 mb-lg-0 text-center text-lg-start">
                        ...
                        <p class="lead fw-normal text-muted mb-5">Mainkan kuis dan jawab soal-soal untuk mendapatkan saldo ShopeePay atau Dana.
        ...
        <div class="container px-5">
            <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                <div class="col-12 col-lg-5">
                    <h2 class="display-4 lh-1 mb-4">S2</h2>
                    <p class="lead fw-normal text-muted mb-5 mb-lg-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
                </div>
